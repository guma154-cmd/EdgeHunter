...
| ----- | ------ | ------ | --------- | ---------- |
| **STORY-06-001** | Concluído | `7cd6501` | [gemini_validator.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator.py), [test_gemini_validator_contract.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/tests/unit/core/test_gemini_validator_contract.py) | Tipos e contratos de input/output puros criados sem imports externos de IA ou rede. |
| **STORY-06-002** | Concluído | `07fe893` | [gemini_validator.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator.py), [test_gemini_validator_prompt.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/tests/unit/core/test_gemini_validator_prompt.py) | Prompt builder determinístico estruturado para paper trading, sem linguagem operacional de aposta. |
| **STORY-06-003** | Concluído | `07fe893` / `706822f` | [gemini_validator.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator.py), [test_gemini_validator_parser.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/tests/unit/core/test_gemini_validator_parser.py) | Parser robusto de JSON com sanitizer de termos proibidos (fail-safe com reversão automática para fallback). |
| **STORY-06-004** | Concluído | `706822f` | [gemini_validator.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator.py), [test_gemini_validator_fake_client.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/tests/unit/core/test_gemini_validator_fake_client.py) | Cliente de IA simulado determinístico e offline. Validação offline integrada e testada. |
| **STORY-06-005** | Concluído | `Uncommitted` | [gemini_validator_persistence.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator_persistence.py), [test_gemini_validator_persistence.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/tests/unit/core/test_gemini_validator_persistence.py) | Schema de banco e repositório SQLite para relatórios locais criados com proteção rígida contra modificação de flags. |
| **STORY-06-006** | Concluído | `Uncommitted` | [routes.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/api/routes.py), [test_api_gemini_validations.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/tests/unit/api/test_api_gemini_validations.py) | Endpoint GET `/api/gemini-validations` exposto de forma protegida por API Key e com envelopes seguros de DTO. |
| **STORY-06-007** | Concluído | `Working Copy` | [ONDA_6_CLOSURE_REPORT.md](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/docs/implementation/ONDA_6_CLOSURE_REPORT.md) | Execução de testes globais, inspeção estática contra rede/dependências de IA e este relatório de encerramento. |
...
* **Contratos Seguros**: Implementados em [gemini_validator.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator.py), definindo `SafeAIValidationInput` e `SafeAIValidationResult` com coerção estrita de flags de segurança e bloqueio de atributos extras.
...
* **Persistência de Relatórios IA**: Tabela `gemini_validation_reports` estruturada em [schema.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/database/schema.py) e repositório seguro com proteção anti-corrupção em [gemini_validator_persistence.py](file:///c:/Users/rafae/OneDrive/Documentos/EdgeHunter/src/edgehunter/core/gemini_validator_persistence.py).
